...
define("SITE_SALT", "DqRzFy#1aS41j,-92Wv0jW+KozEfUE-od:o=Ss2@zQ.h+50bg3;,WucU9,jF3xp.W");
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://unifaction.me");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "unifaction.me";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://unifaction.me.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "unifaction.me.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://unifaction.me.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "unifaction.me.test";
